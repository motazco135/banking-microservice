...
```
## Customer_Service ADL
```text

DESCRIPTION  Architecture for Banking microservices for payment initiation

PROMPT Based on this pseudo-code, write ArchUnit tests in Java for a Spring Boot microservices project
...
FOREACH $S IN {customer_service} DO
